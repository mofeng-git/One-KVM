export default {
  ...
  actionbar: {
    ...
    mouseCompatibility: 'Mouse Compatibility',
    macosDragRequiresBoth: 'Enable and save both relative and absolute mouse interfaces in Settings → HID Settings first.',
  ...
  kvmSwitch: {
    title: 'KVM Switch',
    actionbar: 'Input Switch',
    switch: 'Switch',
    currentInput: 'Current Input',
    notConfigured: 'KVM switch is not configured',
    notConnected: 'Serial device not connected',
    config: 'Configuration',
    enabled: 'Enable input switching',
    device: 'Serial device',
    selectDevice: 'Select serial device...',
    baudRate: 'Baud rate',
    channelCount: 'Channels',
    noDevice: 'No serial devices found',
  },
  setup: {
  ...
  settings: {
    ...
    mouseMacosDragRequiresBoth: 'macOS drag compatibility requires both relative and absolute mouse interfaces. Keep both enabled, or turn off this mode in the console HID menu first.',
    mouseMacosDragDesc: 'Experimental workaround for interrupted drags in macOS absolute mouse mode',
