export default {
  ...
  actionbar: {
    ...
    hidConfig: '鼠键配置',
    mouseSettings: '鼠标设置',
    mouseCompatibility: '鼠标兼容性',
    macosDragRequiresBoth: '请先在系统设置 → HID 设置中启用并保存相对鼠标和绝对鼠标接口。',
  ...
  kvmSwitch: {
    ...
    switch: '切换',
    currentInput: '当前输入',
    notConfigured: 'KVM 切换器尚未配置',
    notConnected: '串口设备未连接',
    config: '配置',
    enabled: '启用输入切换',
    device: '串口设备',
    selectDevice: '选择串口设备...',
  ...
  settings: {
    ...
    mouseMacosDragRequiresBoth: 'macOS 拖拽兼容模式需要同时启用相对鼠标和绝对鼠标接口。请保留两个接口，或先在控制台鼠键配置中关闭该模式。',
    mouseMacosDragDesc: '实验性缓解 macOS 绝对鼠标模式下的拖拽中断',
